...
{/* <div className=" bg-black"></div> */}
      <div className="flex flex-col  space-x-2 md:space-x-10">
...
<div className="navbar-start">
  ...
  <div className="navbar-center sm:hidden flex font-bold font-nunito">
    ...
    <li tabIndex={0}>
      ...
      <div className="navbar-end space-x-4 text-sm font-bold font-nunito">
        <SearchIcon className="hidden h-6 w-6 sm:inline" />
        <a className="hidden btn w-10 lg:inline"><p>Sign in</p></a>
